        ...
        <div className='container mx-auto px-4 md:px-6 pt-16'>
          <div className='max-w-3xl mx-auto text-center'>
            ...
            <p className='text-gray-700 mb-8'>
              We're excited to serve you! Fill out our order form and we'll
              ...
              <div className='grid md:grid-cols-3 gap-6 text-left mb-8'>
                <div className='p-4 bg-gray-50 rounded-lg'>
                  ...
                  <p className='text-sm text-gray-600'>
                    Fill out our order form with your grocery list and delivery
                    details.
                  </p>
                </div>
            ...
            <div className='text-left bg-yellow-50 p-6 rounded-lg border border-yellow-100'>
              ...
              <p className='text-gray-700 mb-3'>
                If you need help with your order or have special requirements,
                feel free to contact us directly:
              </p>
              <p className='text-gray-700'>
                <strong>WhatsApp/Call:</strong> +91 99688 02907
                <br />
                <strong>Email:</strong> bhagwatibazaar@gmail.com
              </p>
            </div>
          </div>
        </div>
