...
import { MapPin, Phone, Mail, Clock, Star, ExternalLink, ShoppingCart } from 'lucide-react';
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {['Tata', 'Patanjali', 'Amul', 'Nestle', 'Parle', 'Britannia', 'Haldiram', 'ITC'].map((brand, index) => (
              <div key={index} className="bg-gray-50 p-6 rounded-lg shadow-sm flex items-center justify-center">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Founded with a passion for quality and community, Bhagwati Bazaar has been serving local families since 1997. 
                We pride ourselves on delivering fresh, high-quality products and exceptional customer service.
              </p>
              <p className="text-gray-700 mb-6">
                From local produce to everyday essentials, we're more than just a store - we're a part of your community.
              </p>
            ...
            <div>
              <img 
                src="https://images.unsplash.com/photo-1522536570511-392580c26815?q=80&w=2070&auto=format&fit=crop" 
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-gray-50 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">Plot No.1, Block-C, 40 Feet Road, Chanakyapuri, New Delhi-110059</p>
              <a 
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">contact@bhagwatibazaar.com</p>
              <a 
